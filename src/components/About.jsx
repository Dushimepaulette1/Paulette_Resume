        ...
        >
          ...
          <motion.div variants={fadeUp}>
            ...
            <p className="about-text">
              ...
              <strong>African Leadership University (ALU)</strong>, pursuing a
              Bachelor's degree in{" "}
              <span className="highlight">Software Engineering</span>. With a
              passion for web development, I'm seeking opportunities to join a
              dynamic team where I can{" "}
